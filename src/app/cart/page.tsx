      ...
      <div className="container mx-auto px-4 lg:px-8 py-8">
        ...
        <div className="overflow-x-auto bg-white shadow-md rounded-lg mb-8">
          <table className="min-w-full text-left">
            ...
            <tbody>
              {[
                { name: "Burger", price: 55, quantity: 1, image: "/cart-img/img-1.png", total: 55 },
                { name: "French Fries", price: 25, quantity: 1, image: "/cart-img/img-2.png", total: 25 },
                { name: "Pizza", price: 15, quantity: 1, image: "/cart-img/img-3.png", total: 15 },
                { name: "Chocolate Muffin", price: 65, quantity: 1, image: "/cart-img/img-4.png", total: 65 },
                { name: "Cheese Platter", price: 66, quantity: 1, image: "/cart-img/img-5.png", total: 66 },
              ].map((item, index) => (
