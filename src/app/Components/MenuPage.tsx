      ...
      <div className="max-w-4xl w-full bg-white shadow-lg rounded-lg flex flex-col md:flex-row">
       ...
       <section className="bg-black py-12 rounded-lg mb-16">
          <div className="grid grid-cols-2 md:grid-cols-4 text-center gap-6">
            <div>
            <Image src="/menu-img/Group-1.png" alt="Partner 1" width={104} height={16} className="h-16 mx-auto" />
              <h3 className="text-4xl font-bold text-white">420+</h3>
              <p className="text-sm text-white">Professional Chiefs</p>
            </div>
            <div>
            <Image src="/menu-img/Group-2.png" alt="Partner 1" width={104} height={60} className="h-16 mx-auto" />
              <h3 className="text-4xl font-bold text-white">320+</h3>
              <p className="text-sm text-white">Items Of Food</p>
            </div>
            <div>
            <Image src="/menu-img/Group-3.png" alt="Partner 1" width={104} height={60} className="h-16 mx-auto" />
              <h3 className="text-4xl font-bold text-white">30+</h3>
              <p className="text-sm text-white">Years Of Experience</p>
            </div>
            <div>
            <Image src="/menu-img/Group-4.png" alt="Partner 1" width={104} height={60} className="h-16 mx-auto" />
      ...
      <div className="max-w-4xl w-full bg-white shadow-lg rounded-lg flex flex-col md:flex-row">
        ...
        <section className="py-12 text-center">
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
            <Image src="/menu-img/Partner (1).png" alt="Partner 1" width={104} height={16} className="h-16 mx-auto" />
            <Image src="/menu-img/Partner (2).png" alt="Partner 2" width={104} height={16} className="h-16 mx-auto" />
            <Image src="/menu-img/Partner (3).png" alt="Partner 3" width={104} height={16} className="h-16 mx-auto" />
            <Image src="/menu-img/Partner (4).png" alt="Partner 4" width={104} height={16} className="h-16 mx-auto" />
            <Image src="/menu-img/Partner (5).png" alt="Partner 5" width={104} height={16} className="h-16 mx-auto" />
            <Image src="/menu-img/Partner (6).png" alt="Partner 5" width={104} height={16} className="h-16 mx-auto" />
          </div>
        </section>
      </main>
    </div>
