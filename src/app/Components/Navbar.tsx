    ...
    <nav className="bg-black text-white py-4">
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6">
          ...
          <Link href="/chef" className="hover:text-orange-500">Our Chefs</Link>
          ...
          <Link href="/faq" className="hover:text-orange-500">FAQs</Link>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <Link href="/chef" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-orange-500 hover:bg-gray-100">
              Our Chefs
            </Link>
            <Link href="/checkout" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-orange-500 hover:bg-gray-100">
              Pages
            </Link>
