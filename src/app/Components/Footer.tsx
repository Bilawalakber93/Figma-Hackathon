  ...
  <div className="container mx-auto px-4">
    <div className="flex flex-wrap justify-between">
      ...
      <div className="w-full md:w-1/4 mb-6 md:mb-0">
        ...
        <ul>
          ...
          <li><Link href="cheif" className="hover:underline">Partners</Link></li>
          <li><Link href="cheif" className="hover:underline">Team</Link></li>
      ...
      <div className="w-full md:w-1/4">
        ...
        <ul>
          <li className="mb-2">
            <Link href="#" className="hover:underline text-sm">Is seafood good for your health?</Link>
            <p className="text-xs text-gray-400">May 25, 2023</p>
          </li>
          <li className="mb-2">
            <Link href="#" className="hover:underline text-sm">Can you trust fast food chains?</Link>
            <p className="text-xs text-gray-400">May 24, 2023</p>
          </li>
          <li>
            <Link href="#" className="hover:underline text-sm">Do you like seafood for breakfast?</Link>
    ...
    <p className="text-center py-4 text-white">
      ...
      <div className="flex space-x-4">
        <Link href="#" className="text-white hover:text-gray-100">Facebook</Link>
        <Link href="#" className="text-white hover:text-gray-100">Twitter</Link>
        <Link href="#" className="text-white hover:text-gray-100">LinkedIn</Link>
        <Link href="#" className="text-white hover:text-gray-100">Instagram</Link>
      </div>
    </div>
  </div>
</footer>
